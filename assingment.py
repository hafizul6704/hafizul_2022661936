...
def create_patient():
    ...
    sql = "INSERT INTO patient_registration (name, age, gender, address_label, identification, phone) VALUES (%s, %s, %s, %s, %s, %s)"
    val = (name, age, gender, address_label, identification, phone)
    mycursor.execute(sql, val)
    mydb.commit()

    # Basic validation
    if name and age and gender and identification and phone:
        patients.append({"Name": name, "Age": age, "Gender": gender, "ID": identification, "Phone": phone})
...
def create_registration_form():
    ...
    registration_window.configure(bg='#73C6B6')

    frame = tk.Frame(registration_window, bg='#73C6B6')

    name_label = tk.Label(frame, text="Name", bg='#73C6B6', fg="#FFFFFF", font=("Arial", 18))
    name_entry = tk.Entry(frame, font=("Arial", 12))

    age_label = tk.Label(frame, text="Age", bg='#73C6B6', fg="#FFFFFF", font=("Arial", 18))
    age_entry = tk.Entry(frame, font=("Arial", 12))

    gender_label = tk.Label(frame, text="Gender", bg='#73C6B6', fg="#FFFFFF", font=("Arial", 18))
    gender_entry = tk.Entry(frame, font=("Arial", 12))

    address_label = tk.Label(frame, text="Address", bg='#73C6B6', fg="#FFFFFF", font=("Arial", 18))
    address_entry = tk.Entry(frame, font=("Arial", 12))

    identification_label = tk.Label(frame, text="ID", bg='#73C6B6', fg="#FFFFFF", font=("Arial", 18))
    identification_entry = tk.Entry(frame, font=("Arial", 12))

    phone_label = tk.Label(frame, text="Phone", bg='#73C6B6', fg="#FFFFFF", font=("Arial", 18))
